...
|4.2|Implement Food search|Develop and integrate the food search feature.|5|Gemma|
|4.3|Nutrition breakdown|Develop and integrate the nutrition breakdown feature.|5|Josh|
|4.4|Nutrition range filter|Develop and integrate the Nutrition range filter feature.|5|Juan|
|4.5|Nutrition level filter|Develop and integrate the nutrition filter feature.|5|Gemma|
|4.6|Additional feature|Develop and integrate the planned additional feature.|5|Josh|
|4.7|User interface implementation|Integrate the planned UI to the functional components of the system.|5|Juan|
|4.8|API implementation|Setup API and make the final system be able to communicated to.|3|All|
|5.1|Testing each of the main features of the application|Ensure all features of the application are in full working order with no system breaking issues.|3|All|
|5.2|R interacts with the GUI|Ensure R and the GUI interact correctly to display the expected result and no graphical errors.|2|Gemma|
|5.3|User experience/use case testing.|Ensure the user experience and interaction with the application is easy to understand.|2|Josh|
|5.4|Bug hunting|Detect and fix bugs.|2|Juan
|5.5|Sending to client for approval/ internal testing|Testing if the program meets the potential user’s/stakeholder’s standards.|2|Gemma/Josh|
|5.6|Performance/ optimisation|Cutting back on suboptimal/ resource intensive code.|2|Juan|
